...
def read_data():
    ...
    uploaded_files = st.sidebar.file_uploader("Bitte laden Sie die drei Modelle hier hoch", accept_multiple_files=True, type=['ifc'])
    ...
    link_text = "Für Beispieldaten hier klicken"
    url = "https://github.com/Jan-HSLU/Baueingabe.git"
